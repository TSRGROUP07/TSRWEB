  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert("Blog yazısı eklenirken hata oluştu");
      }
    } catch (error) {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Yeni Blog/Haber Ekle</h1>
            <p className="text-gray-600 mt-1">Yeni bir blog yazısı veya haber ekleyin</p>
          </div>
        </div>
      </div>
