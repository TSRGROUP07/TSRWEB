...
import { DollarSign, TrendingUp, CheckCircle, Search, Instagram, Youtube, Send, Music, ChevronDown } from "lucide-react";

export default function EmlakDegeriPage() {
  const [propertyCategory, setPropertyCategory] = useState("Tümü");
  ...
  return (
    ...
    <div className="min-h-screen bg-[#b7b1ad] text-white">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight drop-shadow-2xl">
                  25+ Milyon $ Değerinde Emlak
                </h1>
                <p className="text-xl md:text-2xl text-white/95 font-medium max-w-2xl leading-relaxed">
                  Yüksek değerli emlak portföyümüz ile güvenilir yatırım fırsatları. Kaliteli emlaklar, profesyonel yönetim.
                </p>
              </div>
        ...
        <div className="container mx-auto px-6 lg:px-12 py-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
            <div className="space-y-2">
              <label className="text-sm text-white/80 uppercase">EMLAK KATEGORİSİ</label>
      ...
      <div className="container mx-auto px-6 lg:px-12 py-16">
        {/* Portfolio Section */}
        <div id="portfolio-section" className="bg-gradient-to-r from-[#2e3c3a] via-[#3a4d4a] to-[#2e3c3a] text-white rounded-2xl p-8 mb-12 border border-white/10 shadow-xl">
          <h2 className="text-3xl font-bold mb-6">Emlak Portföyümüz</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-8">
              <div className="text-4xl font-bold mb-2">25+</div>
              <div className="text-white/80 text-lg">Milyon $ Toplam Değer</div>
            </div>
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-8">
              <div className="text-4xl font-bold mb-2">500+</div>
              <div className="text-white/80 text-lg">Emlak Birimi</div>
            </div>
          </div>
        </div>
